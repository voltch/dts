...
CONFIG_ZONE_DMA_ALLOW_CUSTOM_SIZE=y
CONFIG_ZONE_DMA_SIZE_MBYTES=512
...
CONFIG_PCIE_DW=y
CONFIG_PCI_EXYNOS=y
# CONFIG_PCI_EXYNOS_TEST is not set
...
CONFIG_SCHED_HMP_DOWN_MIGRATION_COMPENSATION=y
CONFIG_NR_CPUS=8
...
CONFIG_CPU_IDLE_STOP_IDLE_DURING_HOTPLUG=y
...
# CONFIG_CPU_FREQ_DEFAULT_GOV_BLUACTIVE is not set
...
# CONFIG_CPU_FREQ_DEFAULT_GOV_PRESERVATIVE is not set
...
# CONFIG_CPU_FREQ_DEFAULT_GOV_WAVE is not set
...
CONFIG_CPU_FREQ_GOV_CONSERVATIVEX=y
CONFIG_CPU_FREQ_GOV_BLUACTIVE=y
...
CONFIG_CPU_FREQ_GOV_PRESERVATIVE=y
CONFIG_CPU_FREQ_GOV_SHAMUACTIVE=y
CONFIG_CPU_FREQ_GOV_BARRY_ALLEN=y
CONFIG_CPU_FREQ_GOV_HYPER=y
CONFIG_CPU_FREQ_GOV_PEGASUSQ=y
CONFIG_CPU_FREQ_GOV_WAVE=y
...
CONFIG_EXYNOS_BIG_FREQ_BOOST=y
# CONFIG_EXYNOS_DUAL_GOV_PARAMS_SUPPORT is not set
...
CONFIG_ESE_SECURE=y
CONFIG_ESE_SECURE_SPI_PORT=3
CONFIG_ESE_SECURE_GPIO="gpf2"
...
# CONFIG_LINK_POWER_MANAGEMENT is not set
# CONFIG_LINK_DEVICE_WITH_SBD_ARCH is not set
# CONFIG_LINK_DEVICE_NAPI is not set
...
CONFIG_MUIC_UNIVERSAL_MAX77854=y
CONFIG_MUIC_HV=y
# CONFIG_MUIC_HV_12V is not set
# CONFIG_MUIC_SUPPORT_CCIC is not set
...
#
CONFIG_BLK_DEV_SD=y
# CONFIG_SCSI_SKIP_CACHE_OP is not set
CONFIG_SCSI_SKIP_CPU_SYNC=y
...
CONFIG_UFS_UN_18DIGITS=y
CONFIG_UFS_DYNAMIC_H8=y
...
# CONFIG_GLOVE_TOUCH is not set
CONFIG_INPUT_KEYCOMBO=y
CONFIG_HALL=y
# CONFIG_HALL_LOOPCHECK_WA is not set
# CONFIG_SENSORS_HALL_IRQ_CTRL is not set
CONFIG_CERTIFY_HALL=y
# CONFIG_CERTIFY_HALL_NFC_WA is not set
# CONFIG_SENSORS_HALL_FOLDER is not set
...
CONFIG_KEYBOARD_ABOV_FT16XX_TOUCH=y
# CONFIG_KEYBOARD_CYPRESS_TOUCH_20075 is not set
...
# CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_DSX is not set
# CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_DSX2 is not set
# CONFIG_TOUCHSCREEN_FTS is not set
#CONFIG_TOUCHSCREEN_FTS7=y
CONFIG_TOUCHSCREEN_SEC_TS=y
# CONFIG_TOUCHSCREEN_SEC_TS_GLOVEMODE is not set
CONFIG_TOUCHSCREEN_SWEEP2SLEEP=y
...
# CONFIG_TOUCHSCREEN_MMS100S is not set
#CONFIG_INPUT_WACOM=y
# CONFIG_EPEN_WACOM_G5SP is not set
# CONFIG_EPEN_WACOM_G9PM is not set
# CONFIG_EPEN_WACOM_G9PL is not set
# CONFIG_EPEN_WACOM_G9PLL is not set
# CONFIG_EPEN_WACOM_G10PM is not set
# CONFIG_EPEN_WACOM_W9012 is not set
# CONFIG_EPEN_WACOM_W9018 is not set
...
CONFIG_SERIAL_SAMSUNG_UARTS=10
CONFIG_SERIAL_SAMSUNG_CONSOLE=y
CONFIG_S3C_LOWLEVEL_UART_PORT=4
...
CONFIG_MST_SECURE_GPIO=y
CONFIG_PINCTRL_SAMSUNG=y
CONFIG_PINCTRL_EXYNOS=y
CONFIG_SEC_GPIO_DVS=y
CONFIG_SENSORS_FP_SPI_GPIO="gpf3"
...
# CONFIG_FUELGAUGE_MAX17058_POWER is not set
...
# CONFIG_MFD_MAX77833 is not set
CONFIG_MFD_MAX77854=y
...
CONFIG_MFD_ARIZONA_DEFERRED_RESUME=y
# CONFIG_MFD_ARIZONA_I2C is not set
CONFIG_MFD_ARIZONA_SPI=y
# CONFIG_MFD_WM5102 is not set
# CONFIG_MFD_FLORIDA is not set
# CONFIG_MFD_VEGAS is not set
# CONFIG_MFD_WM8997 is not set
CONFIG_MFD_CLEARWATER=y
CONFIG_MFD_MOON=y
# CONFIG_MFD_LARGO is not set
# CONFIG_MFD_MARLEY is not set
...
CONFIG_REGULATOR_MAX77854=y
# CONFIG_REGULATOR_PFUZE100 is not set
# CONFIG_REGULATOR_PWM is not set
# CONFIG_REGULATOR_S2MPA01 is not set
# CONFIG_REGULATOR_S2MPS11 is not set
# CONFIG_REGULATOR_S2MPS13 is not set
# CONFIG_REGULATOR_S2MPS15 is not set
CONFIG_REGULATOR_S2MPS16=y
# CONFIG_REGULATOR_S2MPU03 is not set
# CONFIG_REGULATOR_S2MPB01 is not set
...
CONFIG_MEDIA_M2M1SHOT2=y
# CONFIG_MEDIA_M2M1SHOT2_TESTDEV is not set
...
# CONFIG_SCALER_NO_SOFTRST is not set
CONFIG_VIDEO_EXYNOS_MFC=y
CONFIG_EXYNOS_MFC_V10=y
# CONFIG_VIDEO_EXYNOS_HEVC is not set
CONFIG_VIDEO_EXYNOS_FIMG2D_V5=y
...
# CONFIG_COMPANION_FACTORY_VALIDATION is not set
...
# CONFIG_USE_HOST_FD_LIBRARY is not set
...
CONFIG_MALI_PLATFORM_THIRDPARTY_NAME="8890"
...
CONFIG_EXYNOS_DECON_8890=y
# CONFIG_USE_VSYNC_SKIP is not set
CONFIG_EXYNOS_DECON_FB=y
# CONFIG_DECON_MIPI_DSI_PKTGO is not set
CONFIG_DECON_LPD_DISPLAY=y
CONFIG_FB_WINDOW_UPDATE=y
# CONFIG_DECON_BLOCKING_MODE is not set
CONFIG_FB_DSU=y
#CONFIG_DECON_EVENT_LOG=y
# CONFIG_DSIM_ESD_RECOVERY_NOPOWER is not set
CONFIG_DSIM_ESD_REMOVE_DISP_DET=y
...
# CONFIG_PANEL_S6E3HF4_WQHD is not set
CONFIG_PANEL_S6E3HA3_DYNAMIC=y
CONFIG_SUPPORT_CROSS_DOWNLOAD=y
CONFIG_LCD_WEAKNESS_CCB=y
# CONFIG_PANEL_DDI_SPI is not set
CONFIG_LCD_BURNIN_CORRECTION=y
...
CONFIG_SND_SAMSUNG_COMPR=y
CONFIG_SND_SAMSUNG_AUDSS=y
CONFIG_SND_ESA_SA_EFFECT=y
CONFIG_SND_SAMSUNG_IOMMU=y
...
# CONFIG_SND_SOC_SAMSUNG_ESPRESSO8890_WM5110 is not set
# CONFIG_SND_SOC_SAMSUNG_UNIVERSAL8890_DUMMY is not set
CONFIG_SND_SOC_SAMSUNG_ZERO_CLEARWATER=y
CONFIG_SND_SOC_SAMSUNG_LUCKY_MOON=y
CONFIG_SND_SOC_SAMSUNG_ARIZONA=y
CONFIG_SND_SOC_I2S_TXSLOT_NUMBER=2
CONFIG_SND_SOC_I2S_RXSLOT_NUMBER=2
# CONFIG_SND_SOC_I2S_1840_TDM is not set
CONFIG_SND_SAMSUNG_SEIREN=y
CONFIG_SND_SAMSUNG_SEIREN_OFFLOAD=y
# CONFIG_SND_SAMSUNG_SEIREN_DEBUG is not set
CONFIG_SND_SAMSUNG_ELPE=y
...
CONFIG_SND_SOC_MAX98505=y
# CONFIG_SND_SOC_MAX98505A is not set
...
CONFIG_SND_SOC_CLEARWATER=y
CONFIG_SND_SOC_MOON=y
...
CONFIG_USB_ANDROID_HID_GADGET=y
...
CONFIG_ARGOS=y
# CONFIG_SENTINEL is not set
#CONFIG_SEC_DEBUG=y
# CONFIG_SEC_FACTORY is not set
CONFIG_SEC_HOTPLUG=y

#
# Samsung TN logging feature
#
...
CONFIG_SCHED_HP_EVENT=y
# CONFIG_HP_EVENT_THREAD_GROUP is not set
CONFIG_HP_EVENT_HMP_SYSTEM_LOAD=y
CONFIG_EXYNOS_PM_DVS=y
# CONFIG_EXYNOS_OTP is not set
...
# CONFIG_COMMON_CLK_FREQ_STATS_ACCOUNTING is not set
...
#CONFIG_EXYNOS_IOMMU_EVENT_LOG=y
...
# CONFIG_ARM_EXYNOS_DEVFREQ_DEBUG is not set
CONFIG_ARM_EXYNOS8890_BUS_DEVFREQ=y
...
# CONFIG_STEP_CHARGING is not set
...
CONFIG_WIRELESS_CHARGER_P9220=y
...
CONFIG_SENSORS_SX9310_INIT_TOUCH_THRESHOLD=3000
CONFIG_SENSORS_SX9310_NORMAL_TOUCH_THRESHOLD=168
# CONFIG_SENSORS_SX9310_CP_LDO_CONTROL is not set
# CONFIG_SENSORS_SSP_NOBLELTE is not set
# CONFIG_SENSORS_SSP_ZENLTE is not set
# CONFIG_SENSORS_SSP_ATUC128L5HAR is not set
# CONFIG_SENSORS_SSP_6AXIS is not set
# CONFIG_SENSORS_SSP_MPU6500 is not set
# CONFIG_SENSORS_SSP_BMI168 is not set
# CONFIG_SENSORS_SSP_BMP280 is not set
CONFIG_SENSORS_SSP_TMD4903=y
...
# CONFIG_SENSORS_SSP_C12SD is not set
...
CONFIG_SENSORS_SSP_LPS25H=y
# CONFIG_SENSORS_SSP_BMI058 is not set
# CONFIG_SENSORS_MPU6500_BMI058_DUAL is not set
...
CONFIG_SENSORS_SSP_K6DS3TR=y
CONFIG_SENSORS_SSP_YAS537=y
...
# CONFIG_SENSORS_SSP_TMG399x is not set
# CONFIG_SENSORS_SSP_PROX_AUTOCAL_AMS is not set
CONFIG_SENSORS_SSP_PROX_FACTORYCAL=y
# CONFIG_SENSORS_SSP_SX9306 is not set
# CONFIG_SENSORS_SX9310_USE_2ND_CH is not set
CONFIG_SENSORS_SX9310_NORMAL_TOUCH_THRESHOLD_CH2=246
# CONFIG_SENSORS_HERO2 is not set
# CONFIG_SENSORS_CAN is not set
CONFIG_SENSORS_SSP_INTERRUPT_GYRO_SENSOR=y
CONFIG_SENSORS_SSP_HIFI_BATCHING=y
CONFIG_SENSORS_SSP_LUCKY=y
CONFIG_SSP_MOTOR=y
...
CONFIG_SENSORS_VFS7XXX=y
# CONFIG_SENSORS_FPRINT_SECURE is not set
CONFIG_SENSORS_ET320=y
CONFIG_SENSORS_FINGERPRINT_DUALIZATION=y
CONFIG_SENSORS_FP_LOCKSCREEN_MODE=y
CONFIG_RAS=y
# CONFIG_THUNDERBOLT is not set
CONFIG_TRACE=y
# CONFIG_EXYNOS_DRAMTEST is not set
...
# CONFIG_EXYNOS_SNAPSHOT_PSTORE is not set
...
CONFIG_EXYNOS_SNAPSHOT_SFRDUMP_ADV=y
...
CONFIG_EXYNOS8890_APM=y

#
# EXYNOS_CL_DVFS
#
CONFIG_EXYNOS_CL_DVFS_CPU=y
CONFIG_EXYNOS_CL_DVFS_G3D=y
CONFIG_EXYNOS_CL_DVFS_MIF=y
# CONFIG_EXYNOS_MBOX_DEFAULT_INTERRUPT is not set
CONFIG_EXYNOS_MBOX_DEFAULT_POLLING=y
# CONFIG_EXYNOS_MBOX_INTERRUPT is not set
CONFIG_EXYNOS_MBOX_POLLING=y
#CONFIG_EXYNOS_APM_VOLTAGE_DEBUG=y

#
# CCIC configs
#
# CONFIG_CCIC_NOTIFIER is not set
...
# CONFIG_PRINTK_CORE_NUM is not set
...
CONFIG_CRYPTO_POST_DEFERRED_INIT=y
# CONFIG_CRYPTO_POST_LATE_INIT_SYNC is not set

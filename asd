...
show_one(volt_min_freq, min);
show_one(volt_max_freq, max);
...
store_one(volt_min_freq, min);
store_one(volt_max_freq, max);
...
cpufreq_freq_attr_rw(volt_min_freq);
cpufreq_freq_attr_rw(volt_max_freq);
